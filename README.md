...
- **Real-Time Temporal Frequency Detection in FPGA Using Event-Based Vision Sensor**  <br>
  2018 　	ICCP ( ) 　	IEEE  <br> 
...
- **Passive localization and detection of quadcopter UAVs by using dynamic vision sensor**  <br>
  2017 　	CFIS ( ) 　	IEEE  <br> 
...
- **Video-Based People Fall Detection via Homography Mapping of Foreground Polygons from Overlapping Cameras**  <br>
  2015 　	SITIS ( ) 　	IEEE  <br> 
...
- **Unsupervised Learning of Dense Optical Flow, Depth and Egomotion with Event-Based Sensors**  <br>
  2020 　	IROS ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9341224) <br>
...
- **Live demonstration: Event-driven sensing and processing for high-speed robotic vision**  <br>
  2014 　 BioCAS( ) 　	IEEE  <br> 
...
- **LDNet: End-to-End Lane Marking Detection Approach Using a Dynamic Vision Sensor**  <br>
...
- **Design of Monitoring System Based on Event Camera**  <br>
  2021 　   ICIBA ( ) 　	IEEE  <br> 
...
- **Motion Robust High-Speed Light-Weighted Object Detection With Event Camera**  <br>
...
- **Real-Time Multi-Task Facial Analytics With Event Cameras**  <br>
  2023 　      IEEE Access  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/10188686) <br>
...
- **CED: Color Event Camera Dataset**  <br>
  2019 　	CVPRW ( ) 　	IEEE  <br> 
...
## 本体研究
- **Optimal biasing and physical limits of DVS event noise**  <br>
  2023 　	IISW ( ) 　	arXiv  <br> 
[PDF](https://doi.org/10.48550/arXiv.2304.04019) <br>
...
- **Shining light on the DVS pixel: A tutorial and discussion about biasing and optimization**  <br>
  2021 　	CVPRW ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/10208698) <br>
...
- **Improved contrast sensitivity DVS and its application to event-driven stereo vision**  <br>
  2013 　	IEEE Journal of Solid-State Circuits ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/6572367) <br>
...
- **Event-based camera refractory period characterization and initial clock drift evaluation**  <br>
  2023 　	AFRL ( ) 　	SPIE  <br> 
[PDF](https://www.spiedigitallibrary.org/conference-proceedings-of-spie/12693/2672301/Event-based-camera-refractory-period-characterization-and-initial-clock-drift/10.1117/12.2672301.short) <br>

- **Unraveling the paradox of intensity-dependent DVS pixel noise**  <br>
  2021 　	IISW ( ) 　	arXiv  <br> 
[PDF](https://arxiv.org/abs/2109.08640) <br>

- **Exploiting Alternating DVS Shot Noise Event Pair Statistics to Reduce Background Activity**  <br>
  2021 　	IISW ( ) 　	arXiv  <br> 
[PDF](https://arxiv.org/abs/2304.03494) <br>

- **Automated characterization techniques and testbeds for event-based cameras**  <br>
  2022 　	Infrared Remote Sensing and Instrumentation ( ) 　	SPIE  <br> 
[PDF](https://doi.org/10.1117/12.2634166) <br>

- **Experimental methods to predict dynamic vision sensor event camera performance**  <br>
  2022 　	Optical Engineering ( ) 　	SPIE  <br> 
[PDF](https://doi.org/10.1117/1.OE.61.7.074103) <br>
...
- **An Optically-Reconfigurable PUF Based on Logarithmic Photoreceptor of CMOS Dynamic Vision Sensors**  <br>
  2022 　	IEEE Transactions on Electron Devices ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9837876) <br>
...
- **A 240×180 10mW 12us latency sparse-output vision sensor for mobile applications**  <br>
  2013 　	2013 Symposium on VLSI Circuits ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/6578656) <br>

- **Temporal contrast AER pixel with 0.3%-contrast event threshold**  <br>
  2010 　	Proceedings of 2010 IEEE International Symposium on Circuits and Systems ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/5537153) <br>

- **Design of an RGBW color VGA rolling and global shutter dynamic and active-pixel vision sensor**  <br>
  2015 　	ISCAS ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/7168734) <br>

- **Real-time tracking based on neuromrophic vision**  <br>
  2015 　	NVMIS ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/7457498) <br>

- **A Cognitive Radar for Classification of Resident Space Objects (RSO) operating on Polarimetric Retina Vision Sensors and Deep Learning**  <br>
  2019 　	IST ( ) 　	IEEE  <br> 
...
- **A Dynamic Vision Sensor With 1% Temporal Contrast Sensitivity and In-Pixel Asynchronous Delta Modulator for Event Encoding**  <br>
  2015 　	IEEE Journal of Solid-State Circuits ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/7128412) <br>
...
- **4.1 A 640×480 dynamic vision sensor with a 9µm pixel and 300Meps address-event representation**  <br>
  2017 　	ISSCC ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/7870263) <br>
...
- **A 256x256 6.3pJ/pixel-event Query-driven Dynamic Vision Sensor with Energy-conserving Row-parallel Event Scanning**  <br>
  2021 　	CICC ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9431446) <br>

- **An In-Pixel Gain Amplifier Based Event-Driven Physical Unclonable Function for CMOS Dynamic Vision Sensors**  <br>
  2019 　	ISCAS ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8702472) <br>
...
- **A Sensitive Dynamic and Active Pixel Vision Sensor for Color or Neural Imaging Applications**  <br>
  2018 　	IEEE Transactions on Biomedical Circuits and Systems ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8094907) <br>
...
- **Live demonstration: Behavioural emulation of event-based vision sensors**  <br>
  2012 　	ISCAS ( ) 　	IEEE  <br> 
...
- **A 128× 128 1.5% Contrast Sensitivity 0.9% FPN 3 µs Latency 4 mW Asynchronous Frame-Free Dynamic Vision Sensor Using Transimpedance Preamplifiers**  <br>
  2013 　  IEEE Journal of Solid-State Circuits ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/6407468) <br>
...
- **5.9 A 0.8V Multimode Vision Sensor for Motion and Saliency Detection with Ping-Pong PWM Pixel**  <br>
  2020 　  ISSCC ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9062926) <br>
...
- **An embedded AER dynamic vision sensor for low-latency pole balancing**  <br>
  2015 　  2009 IEEE 12th International Conference on Computer Vision Workshops, ICCV Workshops ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/5457625) <br>
...
- **A 1280×960 Dynamic Vision Sensor with a 4.95-μm Pixel Pitch and Motion Artifact Minimization**  <br>
  2020 　   ISCAS  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9180436) <br>

- **Live demonstration: A 768 × 640 pixels 200Meps dynamic vision sensor**  <br>
  2017 　   ISCAS  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8050397) <br>

- **A USB3.0 FPGA event-based filtering and tracking framework for dynamic vision sensors**  <br>
  2015 　   ISCAS  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/7169172) <br>

- **Color temporal contrast sensitivity in dynamic vision sensors**  <br>
  2017 　   ISCAS  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8050412) <br>

- **A Single-Slope PWM Imaging Method for Multi-Mode Dynamic Vision Sensor**  <br>
  2021 　   ASICON  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9620421) <br>
...
- **Live demonstration: Hardware implementation of convolutional STDP for on-line visual feature learning**  <br>
  2017 　   ISCAS  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8050395) <br>
...
- **A Motion Sensor with On-Chip Pixel Rendering Module for Optical Flow Gradient Extraction**  <br>
  2018 　   ISCAS  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8351312) <br>
...
- **An Event-Driven Multi-Kernel Convolution Processor Module for Event-Driven Vision Sensors**  <br>
  2012 　   IEEE Journal of Solid-State Circuits ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/6054033) <br>
...
- **Low Latency Event-Based Filtering and Feature Extraction for Dynamic Vision Sensors in Real-Time FPGA Applications**  <br>
  2019 　    IEEE Access  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8836544) <br>
...
- **Systolic-Array Spiking Neural Accelerators with Dynamic Heterogeneous Voltage Regulation**  <br>
  2021 　    IJCNN ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9534037) <br>
...
[PDF](https://ieeexplore.ieee.org/document/7362498) <br>
...
- **Measuring Power Usage and Sensitivity to Movement for Event-Based Cameras**  <br>
  2020 　    2020 IEEE SENSORS  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9278911) <br>

- **Towards Always-on Event-based Cameras for Long-lasting Battery-operated Smart Sensor Nodes**  <br>
  2021 　    I2MTC ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9460037) <br>
...
- **Retinomorphic Event-Based Vision Sensors: Bioinspired Cameras With Spiking Output**  <br>
  2014 　      Proceedings of the IEEE ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/6887319) <br>
...
- **Calibration of Event-based Camera and 3D LiDAR**  <br>
  2018 　      WRC SARA ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8584215) <br>
...
- **1.22μm 35.6Mpixel RGB Hybrid Event-Based Vision Sensor with 4.88μm-Pitch Event Pixels and up to 10K Event Frame Rate by Adaptive Control on Event Sparsity**  <br>
  2023 　        ISSCC ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/10067520) <br>
...
- **Ed-PUF: Event-Driven Physical Unclonable Function for Camera Authentication in Reactive Monitoring System**  <br>
  2020 　             IEEE Transactions on Information Forensics and Security ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9019871) <br>

- **Feature-based Event Stereo Visual Odometry**  <br>
  2021 　             ECMR ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9568811) <br>

- **Effects of Cooling on the SNR and Contrast Detection of a Low-Light Event-Based Camera**  <br>
  2018 　            IEEE Transactions on Biomedical Circuits and Systems ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8495003) <br>

- **GraDED: A graph-based parametric dictionary learning algorithm for event detection**  <br>
  2017 　            ICIP ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8296591) <br>

- **Event-based improved FAST corner feature detection algorithm**  <br>
  2019 　            CCDC ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8833122) <br>

- **Stereo Hybrid Event-Frame (SHEF) vCameras for 3D Perception**  <br>
  2021 　            IROS ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9636312) <br>

- **Real-time event simulation with frame-based cameras**  <br>
  2023 　            ICRA ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/10160654) <br>

- **Event-LSTM: An Unsupervised and Asynchronous Learning-Based Representation for Event-Based Data**  <br>
  2022 　            IEEE Robotics and Automation Letters ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9713987) <br>

- **FlyDVS: An Event-Driven Wireless Ultra-Low Power Visual Sensor Node**  <br>
  2021 　            DATE ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9474260) <br>

- **Event Camera-based Motion Segmentation via Depth Estimation and 3D Motion Compensation**  <br>
  2022 　            CCC ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9902710) <br>

- **Machine vision using combined frame-based and event-based vision sensor**  <br>
  2015 　            ISCAS ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/7168731) <br>
...
- **DART: Distribution Aware Retinal Transform for Event-Based Cameras**  <br>
  2020 　             IEEE Transactions on Pattern Analysis and Machine Intelligence ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8723171) <br>

- **Parallel Computation of Event-Based Visual Features Using Relational Graphs**  <br>
  2021 　             CISS ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9400272) <br>

- **Asynchronous Corner Detection and Tracking for Event Cameras in Real Time**  <br>
  2018 　              IEEE Robotics and Automation Letters  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8392795) <br>

- **SCSE-E2VID: Improved event-based video reconstruction with an event camera**  <br>
  2022 　              SMC ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9945237) <br>

- **Fast event-based Harris corner detection exploiting the advantages of event-driven cameras**  <br>
  2016 　              IROS ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/7759610) <br>

- **Event-Based, 6-DOF Camera Tracking from Photometric Depth Maps**  <br>
  2017 　              IEEE Transactions on Pattern Analysis and Machine Intelligence ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8094962) <br>

- **Contour Motion Estimation for Asynchronous Event-Driven Cameras**  <br>
  2014 　              Proceedings of the IEEE ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/6895239) <br>

- **Stereo Depth Estimation Based on Adaptive Stacks from Event Cameras**  <br>
  2023 　             IECON 2023- 49th Annual Conference of the IEEE Industrial Electronics Society ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/10311771) <br>

- **L2E: Lasers to Events for 6-DoF Extrinsic Calibration of Lidars and Event Cameras**  <br>
  2023 　             ICRA ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/10161220) <br>

- **ECSNet: Spatio-Temporal Feature Learning for Event Camera**  <br>
  2022 　              IEEE Transactions on Circuits and Systems for Video Technology ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9869656) <br>

- **An SNN-Based and Neuromorphic-Hardware-Implementable Noise Filter with Self-adaptive Time Window for Event-Based Vision Sensor**  <br>
  2021 　              IJCNN ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9534073) <br>

- **A Multi-Cluster Tracking Algorithm with an Event Camera**  <br>
  2019 　              NAECON ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9058204) <br>

- **A Multi-Scale Recurrent Framework for Motion Segmentation With Event Camera**  <br>
  2023 　              IEEE Access ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/10196434) <br>

- **Comparing Representations in Tracking for Event Camera-based SLAM**  <br>
  2021 　              CVPRW ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/10196434) <br>

- **Deep Learning For Pose Estimation From Event Camera**  <br>
  2022 　              DICTA ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/10034617) <br>

- **Stereo Depth Estimation Based on Adaptive Stacks from Event Cameras**  <br>
  2023 　              IECON 2023- 49th Annual Conference of the IEEE Industrial Electronics Society ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/10311771) <br>

- **Hybrid Deblur Net: Deep Non-Uniform Deblurring With Event Camera**  <br>
  2020 　              IEEE Access ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9165110) <br>

- **An Asynchronous Kalman Filter for Hybrid Event Cameras**  <br>
  2021 　              ICCV ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9710035) <br>

- **High Frame Rate Video Reconstruction Based on an Event Camera**  <br>
  2020 　              IEEE Transactions on Pattern Analysis and Machine Intelligence ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9252186) <br>

- **TimeReplayer: Unlocking the Potential of Event Cameras for Video Interpolation**  <br>
  2022 　              CVPR ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9880013) <br>

- **Time-to-Contact Map by Joint Estimation of Up-to-Scale Inverse Depth and Global Motion using a Single Event Camera**  <br>
  2023 　              ICCV ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/10377470) <br>

- **Dense Depth-Map Estimation Based on Fusion of Event Camera and Sparse LiDAR**  <br>
  2022 　              IEEE Transactions on Instrumentation and Measurement ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9686362) <br>

- **Speed Invariant Time Surface for Learning to Detect Corner Points With Event-Based Cameras**  <br>
  2019 　              CVPR ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/8954376) <br>

- **LIAF-Net: Leaky Integrate and Analog Fire Network for Lightweight and Efficient Spatiotemporal Information Processing**  <br>
  2021 　	IEEE Transactions on Neural Networks and Learning Systems  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9429228) <br>

- **Mapping from Frame-Driven to Frame-Free Event-Driven Vision Systems by Low-Rate Rate Coding and Coincidence Processing--Application to Feedforward ConvNets**  <br>
  2013 　	IEEE Transactions on Pattern Analysis and Machine Intelligence ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/6497055) <br>

- **The Hardware Impact of Quantizaton and Pruning for Weights in Spiking Neural Networks**  <br>
  2023 　	IEEE Transactions on Circuits and Systems II: Express Briefs  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/10078327) <br>

- **SpikeMS: Deep Spiking Neural Network for Motion Segmentation**  <br>
  2021 　	IROS  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9636506) <br>

- **[WIP] Unlocking Static Images for Training Event-driven Neural Networks**  <br>
  2022  　	EBCCSP ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9845526) <br>

- **Event-VPR: End-to-End Weakly Supervised Deep Network Architecture for Visual Place Recognition Using Event-Based Vision Sensor**  <br>
  2022  　	IEEE Transactions on Instrumentation and Measurement  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9760407) <br>

- **Early Image Detection Using Event Based Vision**  <br>
  2020  　	ICloT  ( ) 　	IEEE  <br> 
[PDF](https://ieeexplore.ieee.org/document/9089511) <br>

- **Real-Time 3D Reconstruction and 6-DoF Tracking with an Event Camera**  <br>
  2016 　              Computer Vision – ECCV 2016 ( ) 　	Springer Link  <br> 
[PDF](https://link.springer.com/chapter/10.1007/978-3-319-46466-4_21) <br>

- **Fine-Grained Video Deblurring with Event Camera**  <br>
  2021 　              International Conference on Multimedia Modeling ( ) 　	Springer Link  <br> 
[PDF](https://link.springer.com/chapter/10.1007/978-3-030-67832-6_29) <br>

- **Globally-Optimal Event Camera Motion Estimation**  <br>
  2020 　              Computer Vision – ECCV 2020  ( ) 　	Springer Link  <br> 
[PDF](https://link.springer.com/chapter/10.1007/978-3-030-58574-7_4) <br>

- **An Event-Based Optical Flow Algorithm for Dynamic Vision Sensors**  <br>
  2017 　              International Conference Image Analysis and Recognition ( ) 　	Spinger Link  <br> 
[PDF](https://link.springer.com/chapter/10.1007/978-3-319-59876-5_21) <br>

- **A Spatio-Temporal Event Data Augmentation Method for Dynamic Vision Sensor**  <br>
  2022 　              International Conference on Neural Information Processing ( ) 　	Spinger Link  <br> 
[PDF](https://link.springer.com/chapter/10.1007/978-981-99-1645-0_35) <br>

- **DVS-Voltmeter: Stochastic Process-Based Event Simulator for Dynamic Vision Sensorsr**  <br>
  2022 　              European Conference on Computer Vision ( ) 　	Spinger Link  <br> 
[PDF](https://link.springer.com/chapter/10.1007/978-3-031-20071-7_34) <br>

- **EV-Perturb: event-stream perturbation for privacy-preserving classification with dynamic vision sensors**  <br>
  2024 　             Multimedia Tools and Applications ( ) 　	Spinger Link  <br> 
[PDF](https://link.springer.com/article/10.1007/s11042-023-15743-w) <br>


- **A robust autofocusing method for microscopic imaging based on an event camera**  <br>
  2024 　              Optics and Lasers in Engineering  ( ) 　	Elsevier  <br> 
[PDF](https://www.sciencedirect.com/science/article/pii/S0143816624000058) <br>

- **An ultra-high-speed hardware accelerator for image reconstruction and stereo rectification on event-based camera**  <br>
  2022 　              Microelectronics Journal ( ) 　	Elsevier  <br> 
[PDF](https://www.sciencedirect.com/science/article/pii/S0026269221002949) <br>

- **Extraction of temporally correlated features from dynamic vision sensors with spike-timing-dependent plasticity**  <br>
  2012 　              Neural Networks ( ) 　	Elsevier  <br> 
[PDF](https://www.sciencedirect.com/science/article/abs/pii/S0893608012000512) <br>

- **Neuromorphic Downsampling of Event-Based Camera Output**  <br>
  2023 　             Neuromorphic Downsampling of Event-Based Camera Output ( ) 　	ACM  <br> 
[PDF](https://dl.acm.org/doi/10.1145/3584954.3584962) <br>

- **Event-Based Camera Simulation Wrapper for Arcade Learning Environment**  <br>
  2022 　             ICONS ( ) 　	ACM  <br> 
[PDF](https://dl.acm.org/doi/10.1145/3546790.3546817) <br>

- **Few-shot classification without forgetting of event-camera data**  <br>
  2021 　             ICVGIP ( ) 　	ACM  <br> 
[PDF](https://dl.acm.org/doi/10.1145/3490035.3490304) <br>

- **Event Camera Survey and Extension Application to Semantic Segmentation**  <br>
  2022 　             IPMV ( ) 　	ACM  <br> 
[PDF](https://dl.acm.org/doi/10.1145/3529446.3529465) <br>

- **Standard and Event Cameras Fusion for Feature Tracking**  <br>
  2021 　             ICMVA ( ) 　	ACM  <br> 
[PDF](https://dl.acm.org/doi/10.1145/3459066.3459075) <br>

- **Integrating event-based dynamic vision sensors with sparse hyperdimensional computing: a low-power accelerator with online learning capability**  <br>
  2020 　             ISLPED ( ) 　	ACM  <br> 
[PDF](https://dl.acm.org/doi/10.1145/3370748.3406560) <br>

- **REMOT: A Hardware-Software Architecture for Attention-Guided Multi-Object Tracking with Dynamic Vision Sensors on FPGAs**  <br>
  2022 　             FPGA ( ) 　	ACM  <br> 
[PDF](https://dl.acm.org/doi/10.1145/3490422.3502365) <br>

- **An Improved Approach for Visualizing Dynamic Vision Sensor and its Video Denoising**  <br>
  2017 　             ICVIP ( ) 　	ACM  <br> 
[PDF](https://dl.acm.org/doi/10.1145/3177404.3177411) <br>

- **基于事件相机的图像重构综述**  <br>
  2023 　             电子与信息学报 ( ) 　	CNKI  <br> 
[PDF](https://kns.cnki.net/kcms2/article/abstract?v=xFzLC8E_KjGwhLndYz4e_ggWnRu5amci6bdKn4t65yF0cbzSw5DdnveXKM14Ln6O9_tGI18v7E7GaEyiWHOKogr0a6TncT8Fho5PZ4_zRtcY_7lc8oQXedL3jipTcWrvgGQwH-V8sf0MxkwwLlK4-g==&uniplatform=NZKPT&language=CHS) <br>

- **仿视网膜传感器视觉重建算法研究综述**  <br>
  2023 　             中国科学；信息科学 ( ) 　	CNKI  <br> 
[PDF](https://kns.cnki.net/kcms2/article/abstract?v=xFzLC8E_KjGQLOlexSpOzr9SEkFT4e0pSYg6Mit3CbM99MNIazNnbNsO1s53bvTmu3GNLtWf1RemjFRKBrw6wg8cTBm3wvO9ZNVe_EsdizVFo4hgHezZuQ9sA9nOrBwtBrM1De_nc-QeRW2GnutEQA==&uniplatform=NZKPT&language=CHS) <br>

- **一种基于帧图像的动态视觉传感器样本集建模方法**  <br>
  2020 　             电子学报 ( ) 　	CNKI  <br> 
[PDF](https://kns.cnki.net/kcms2/article/abstract?v=xFzLC8E_KjHJ0lLhGuBLFG_8VMsPLqM_P8abYp61Ee6ljQsIkK2o8YfcnY_09XK9soe9ZcqxtcVniNeHzPSCMiTdshhra8Ot44hm9aS3NK-DzoOlzC4kbLNn3-unjX5YMazoHgaSfTt53AI3LDi8Ew==&uniplatform=NZKPT&language=CHS) <br>

- **时域感兴趣区域精确定位与膜电位多核调整的动态视觉传感器数据分类**  <br>
  2020 　             控制理论与应用 ( ) 　	CNKI  <br> 
[PDF](https://kns.cnki.net/kcms2/article/abstract?v=xFzLC8E_KjE6c_tzy019bDClxp_tgVkxam4Hec1FJD5ikiA1yQagr9PlXREMt4WaM96pff_rQaFhGFN6Yos0hSQ8GXqXtJLU8LXfXb3hLlwK6ekU8J4xQtaVkMT3hCAE_p-UCKVyQzaNh2McyM3wrw==&uniplatform=NZKPT&language=CHS) <br>

- **动态视觉传感器网络多节点协作覆盖算法**  <br>
  2011 　             计算机工程 ( ) 　	CNKI  <br> 
[PDF](https://kns.cnki.net/kcms2/article/abstract?v=xFzLC8E_KjHOpl04Dte7KeLemJxF5d9AYIQHzfsvEbYOYnzI7eVdCO1RZaAt5D82lvyNZ8tElIeXgb5DsqFoFRCeYI5f0Z3QkWS1cAwV-Q9z9KPMjS0oFJT27tIkr7Vwoy9COnHt6RY=&uniplatform=NZKPT&language=CHS) <br>

- **一种新的动态视觉传感器网络目标覆盖率算法**  <br>
  2010 　             计算机应用研究 ( ) 　	CNKI  <br> 
[PDF](https://kns.cnki.net/kcms2/article/abstract?v=xFzLC8E_KjHjSLa8UBPfO6zMLKvTicuyquk08Cr5WnkBxVbrJNM50Gbn8TXViONIpKDYxubcP12zvMz1iGg4wcnt0Nr445CsDduUYiHLva0aHyUVEIG9WSpj5jv7vXJ37h7y_0W3eTY=&uniplatform=NZKPT&language=CHS) <br>

- **基于事件相机的空间目标事件流降噪算法**  <br>
  2023 　	红外与激光工程 ( ) 　	CNKI <br> 
[PDF](https://kns.cnki.net/kcms2/article/abstract?v=xFzLC8E_KjEVSpB9F4sbRa2lUN3ntcW1F6AJFlAKNzaJRVRECfFF3LMfpVqyKBXQnDVGh8C7J9dl1KOS4pZNVrj2Cr2USYbx3sGhHY4QSKiV9rZ_lePFQ-d_8a5BbF4zh9X3FypXLcR53jcpAz7xYA==&uniplatform=NZKPT&language=CHS) <br>

- **面向事件相机的时间信息融合网络框架**  <br>
  2023 　	计算机科学 ( ) 　	CNKI <br> 
[PDF](https://kns.cnki.net/kcms2/article/abstract?v=xFzLC8E_KjHOgs0_w9S1cCFbqgphWaY_lLmsPl0tQYnwjLooH7rqOLyLaVcWd1vSLm1WlYyc9SMEvsBDh7KamCzEcd-gazXiINm-BcnwnUkYThRTtOb4Se0TQLvJ6bMgWboNTzwT_M6GdrP4G20STQ==&uniplatform=NZKPT&language=CHS) <br>

- **基于事件相机的连续光流估计**  <br>
  2023 　	自动化学报 ( ) 　	CNKI <br> 
[PDF](https://kns.cnki.net/kcms2/article/abstract?v=xFzLC8E_KjEkRz1XKTAu2zhCi9BFxfE0RWQs9AQ4aYeORIh3dNaxY086pxY9WcUmMuagRfw8ZTPSvhSHgZbZ5pLSlv1EiiiFjXYHeytU9GmXG8ZPnmnQFcolztLgfxnrEKD0NY2_5QT6HnGc0u-UoQ==&uniplatform=NZKPT&language=CHS) <br>

- **基于事件相机的合成孔径成像**  <br>
  2023 　	自动化学报 ( ) 　	CNKI <br> 
[PDF](https://kns.cnki.net/kcms2/article/abstract?v=xFzLC8E_KjFgv5cUHJpZBsIWEEHe2cNMi2gf8tHb0QXEuYhSdJ-sYn4_70UFRfLs2OIMZu0ys8YmtSc6FhzBJp5Y5IroMyGYeFrvf1i7wQN2KTrqdTCNYf5yKeinoSHD9TTuKS83Tya6CQytXHfzBg==&uniplatform=NZKPT&language=CHS) <br>

- **基于事件相机的可视化及降噪算法**  <br>
  2021 　北京航天航空大学学报 ( ) 　	CNKI <br> 
[PDF](https://kns.cnki.net/kcms2/article/abstract?v=xFzLC8E_KjE-_JNGA5Yszu7s0J2TlKh0JM34DWr6EfIFaLMGdZmV9yLd64oNaOTQHhNGxSc5VXTcMZj2PFyPVX5K4LcGcrbnRGWV6O-qgzDwysA2UhgKw8TIZpzSdkQUgYp4Dbj8oRsY2lDRYPJutg==&uniplatform=NZKPT&language=CHS) <br>

- **基于事件相机的视觉跟踪算法综述**  <br>
  2020 　小型微型计算机系统 ( ) 　	CNKI <br> 
[PDF](https://kns.cnki.net/kcms2/article/abstract?v=xFzLC8E_KjEh8i4L-89J-WmwhwS7mgN19yWGx3h75WsVFavWmtpt5qxEXSDJ0URvvK6o_I_0QRsl3hMjDFJwPF_T_zAuAtu7kvUBNREvy9xhANv9098xTZNLDv8P0V-AqI6FGyvrlwrfTM4i_jy7_g==&uniplatform=NZKPT&language=CHS) <br>

- **基于事件相机的定位与建图算法:综述**  <br>
  2021 　自动化学报 ( ) 　	CNKI <br> 
[PDF](https://kns.cnki.net/kcms2/article/abstract?v=xFzLC8E_KjH80uVmt05oePjG6V84QjVpltBfXwwkhWeNf3u4cgCFfz2HvvJsaO-Vpa_XrLrY0fWjmyQATJVk-EIib9DR8nLp2fyu15RgWw40dcRrMm1G8Ubia54wHOb4u_Kj2Y0gra3G7HFUthsmpw==&uniplatform=NZKPT&language=CHS) <br>

- **低维流形约束下的事件相机去噪算法**  <br>
  2019 　信号处理 ( ) 　	CNKI <br> 
[PDF](https://kns.cnki.net/kcms2/article/abstract?v=xFzLC8E_KjGxi5OmG-3hXvU1Ml4Wn-bLnJwt1_Xp_MtcFyVoYMXnnL0qWVful7W9I8a9kiP1TlWZ-DdUg4r6FFUh2nYM8tNPOM0gVUlKIb4zvip2Hn4wSZIi_jDRyj8mqcmexdMwMHUigGHzFi2MPQ==&uniplatform=NZKPT&language=CHS) <br>
